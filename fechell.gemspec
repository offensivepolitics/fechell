...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/defs/3.00.csv", "lib/defs/5.00.csv", "lib/defs/5.1.csv", "lib/defs/5.2.csv", "lib/defs/5.3.csv", "lib/defs/6.1.csv", "lib/defs/6.2.csv", "lib/defs/6.3.csv", "lib/defs/6.4.csv", "lib/fechell.rb", "Manifest", "Rakefile", "README.rdoc", "fechell.gemspec"]
  s.has_rdoc = true
